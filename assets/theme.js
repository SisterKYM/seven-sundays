...
theme.customerTemplates = (function() {
  ...
  function customerAddressForm() {
    ...
    $('.address-new-toggle').on('click', function() {
      ...
      $newAddressForm.parent().toggleClass('hide');
  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _updatePrice: function(evt) {
      ...
      if (variant.compare_at_price > variant.price) {
        ...
        $regularPrice.attr('data-price', variant.price);
        var $comparePrice = $('[data-compare-price]');
        var $discountPercent = $('.product-price__unit__left');
        var $discountAmount = $('.product-price__unit__right');
        $comparePrice.html(theme.Currency.formatMoney(variant.compare_at_price, theme.moneyFormat));
        $comparePrice.attr('data-price', variant.compare_at_price);
        var discountAmount = variant.compare_at_price - variant.price;
        var discountPercent = Math.floor(discountAmount * 100 / variant.compare_at_price);
        $comparePrice.attr('data-discount', discountPercent);
        $discountPercent.html('-' + discountPercent + '%');
        $discountAmount.html('Ersparnis: ' + theme.Currency.formatMoney(discountAmount, theme.moneyFormat));
        /*
        $regularPrice.html(
          theme.Currency.formatMoney(
            variant.compare_at_price,
